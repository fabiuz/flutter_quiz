...
class CorrectWrongOverlay extends StatefulWidget {
  ...
  final bool _isCorret;
  final VoidCallback _onTap; 

  CorrectWrongOverlay(this._isCorret, this._onTap);
          ...
          children: <Widget>[
            Container(
              ...
              child: Transform.rotate(
                ...
                child: Icon(widget._isCorret == true ? Icons.done : Icons.clear, size: _iconAnimation.value * 80.0)
              ),
            ...
            Text(
              widget._isCorret == true ? "Correct!" : "Wrong!", style: TextStyle(color: Colors.white, fontSize: 30.0)),
          ],
        ),
      ),
    );
